<%@page import="java.sql.ResultSet"%><%@page import="java.sql.Statement"%><%@page import="java.sql.DriverManager"%><%@page import="java.sql.Connection"%><%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div class="wrap">
      ...
      <div class="menu_wrap">
        <div class="menu">
          <div class="top">
            ...
            <div class="member">
              <div class="mem">
                <span class="pic" style="background:url('/img/profile/ico/ico_22.png') 50% 50% no-repeat;"></span>
                <p class="info">사과색깔</p>
              </div>
            </div>
          </div>
              ...
              <ul>
                ...
                <li class="depth_2">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="/camp">캠핑·글램핑</a>
                    </li>
                    <li>
                      <a href="/gesthouse">게스트하우스</a>
                    </li>
                    <li>
                      <a href="/koreanhouse">한옥 </a>
                    </li>
                  </ul>
                </li>
                <li>
              ...
              <ul>
                <li class="depth_2">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="${context }inquiryForm">1대1문의</a>
                    </li>
                    <li>
                      <a href="${context }faqForm">고객문의</a>
                    </li>
                  </ul>
                </li>
              </ul>
      ...
      <div id="content" class="sub_wrap more_wrap">
        ...
        <nav>
          <ul>
            <li>
              <a class="active" href="/noticeForm">공지사항</a>
            </li>
            <li>
              <a class="" href="/faqForm">자주 묻는 질문</a>
            </li>
            <li>
              <a class="" href="/inquiryForm">1:1 문의</a>
            </li>
          </ul>
        </nav>
        <div class="align_rt">
          ...
          <div class="notice">
            ...
            <!-- Tab -->
            <div class="tab">
              <span class="tab_btn active">서비스 공지사항 <i class="ico_new">NEW</i>
              </span>
            ...
            <div class="tab_each">
              <ul id="notices" class="show_list open_list">
                <div align="center">
                  <!-- <h1>게시글 목록</h1><c:choose><c:when test="${empty notices }"><h1> 등록된 공지가 존재하지 않습니다. </h1></c:when><c:otherwise><table border=1><tr><th width="50">No.</th><th width="250">제목</th><th width="100">작성자</th><th width="100">작성일</th><th width="60">조회수</th></tr><c:forEach var="notice" items="${ notices}"><tr><td>${notice.no }</td><td onclick="location.href='noticeContent?no=${notice.no }'">
								${notice.title }
							</td><td>${notice.id }</td><td>${notice.writeDate }</td><td>${notice.hits }</td></tr></c:forEach><tr><td colspan="4">
							${result }
						</td><td><button type="button" onclick="location.href='noticeWrite'">글쓰기</button></td></tr></table></c:otherwise></c:choose> -->
                </div>
                </span>
                </a>
                <div style="display: none;">
                  <div>
                    <span style="font-family: arial; font-size: 10pt;">저기어때!.&nbsp;</span>
                    <span style="font-family: arial; font-size: 10pt;">취향대로 머물다&nbsp;</span>
                    <span style="font-family: arial; font-size: 10pt;">여기어때입니다.</span>
                  </div>
                  <div>
                    <span style="font-family: arial; font-size: 10pt;">8월 3</span>
                    <span style="font-family: arial; font-size: 10pt;">차 '모텔 리얼리뷰 무료초대권' 이벤트 당첨자를 발표합니다.</span>
                  </div>
                  <div>
                      ...
                      <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="0" dir="ltr" style="table-layout: fixed; font-size: 10pt; font-family: arial, sans, sans-serif; width: 0px;">
                        ...
                        <tbody>
                          <tr style="height: 21px;">
                            <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;■ 이벤트 당첨자&quot;}" style="border-bottom: 1px solid rgb(153, 153, 153); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Arial; font-size: 9pt; font-weight: bold;">■ 이벤트 당첨자</td>
                            <td style="border-bottom: 1px solid rgb(153, 153, 153); overflow: hidden; padding: 2px 3px; vertical-align: middle;"></td>
                            <td style="border-bottom: 1px solid rgb(153, 153, 153); overflow: hidden; padding: 2px 3px; vertical-align: middle;"></td>
                          </tr>
                          <tr style="height: 33px;">
                            <td rowspan="4" colspan="1" data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;숙박\n무료\n초대권\n(7명)&quot;}" style="border-right: 1px solid rgb(153, 153, 153); border-bottom: 1px solid rgb(153, 153, 153); border-left: 1px solid rgb(153, 153, 153); overflow: hidden; padding: 2px 3px; vertical-align: middle; background-color: rgb(102, 102, 102); font-family: Arial; font-size: 9pt; color: rgb(255, 255, 255); text-align: center;">
                              <div style="max-height: 132px;">숙박 <br>무료 <br>초대권 <br>(7명) </div>
                            </td>
                            <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;· 춘천사랑몽&quot;}" data-sheets-formula="=&quot;·&quot;&amp;&quot; &quot;&amp;R[0]C[-3]" style="border-right: 1px solid rgb(255, 255, 255); border-bottom: 1px solid rgb(255, 255, 255); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Arial; font-size: 9pt;">· 춘천사랑몽</td>
                            <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;· 촵촵촵촤&quot;}" data-sheets-formula="=&quot;·&quot;&amp;&quot; &quot;&amp;R[0]C[-3]" style="border-right: 1px solid rgb(153, 153, 153); border-bottom: 1px solid rgb(255, 255, 255); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Arial; font-size: 9pt; overflow-wrap: break-word;">· 촵촵촵촤</td>
                          </tr>
                          <tr style="height: 33px;">
                            <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;· 김뜐뜐&quot;}" data-sheets-formula="=&quot;·&quot;&amp;&quot; &quot;&amp;R[0]C[-3]" style="border-right: 1px solid rgb(255, 255, 255); border-bottom: 1px solid rgb(255, 255, 255); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Arial; font-size: 9pt;">· 김뜐뜐</td>
                            <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;· 네덜란드카멜레온&quot;}" data-sheets-formula="=&quot;·&quot;&amp;&quot; &quot;&amp;R[0]C[-3]" style="border-right: 1px solid rgb(153, 153, 153); border-bottom: 1px solid rgb(255, 255, 255); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Arial; font-size: 9pt; overflow-wrap: break-word;">· 네덜란드카멜레온</td>
                          </tr>
                          <tr style="height: 33px;">
                            <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;· 난완전예뻐&quot;}" data-sheets-formula="=&quot;·&quot;&amp;&quot; &quot;&amp;R[0]C[-3]" style="border-right: 1px solid rgb(255, 255, 255); border-bottom: 1px solid rgb(255, 255, 255); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Arial; font-size: 9pt;">· 난완전예뻐</td>
                            <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;· 파이어볼러챔피언&quot;}" data-sheets-formula="=&quot;·&quot;&amp;&quot; &quot;&amp;R[0]C[-3]" style="border-right: 1px solid rgb(153, 153, 153); border-bottom: 1px solid rgb(255, 255, 255); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Arial; font-size: 9pt; overflow-wrap: break-word;">· 파이어볼러챔피언</td>
                          </tr>
                          <tr style="height: 33px;">
                            <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;· 둥글넓적한가을배추&quot;}" data-sheets-formula="=&quot;·&quot;&amp;&quot; &quot;&amp;R[0]C[-3]" style="border-right: 1px solid rgb(255, 255, 255); border-bottom: 1px solid rgb(153, 153, 153); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Arial; font-size: 9pt;">· 둥글넓적한가을배추</td>
                            <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;· &quot;}" data-sheets-formula="=&quot;·&quot;&amp;&quot; &quot;&amp;R[0]C[-3]" style="border-right: 1px solid rgb(153, 153, 153); border-bottom: 1px solid rgb(153, 153, 153); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Arial; font-size: 9pt; overflow-wrap: break-word;">·</td>
                          </tr>
                          <tr style="height: 49px;">
                            <td rowspan="2" colspan="1" data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;대실\n무료\n초대권\n(4명)&quot;}" style="border-right: 1px solid rgb(153, 153, 153); border-bottom: 1px solid rgb(153, 153, 153); border-left: 1px solid rgb(153, 153, 153); overflow: hidden; padding: 2px 3px; vertical-align: middle; background-color: rgb(102, 102, 102); font-family: Arial; font-size: 9pt; color: rgb(255, 255, 255); text-align: center;">
                              <div style="max-height: 98px;">대실 <br>무료 <br>초대권 <br>(4명) </div>
                            </td>
                            <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;· 굿러브&quot;}" data-sheets-formula="=&quot;·&quot;&amp;&quot; &quot;&amp;R[0]C[-3]" style="border-right: 1px solid rgb(255, 255, 255); border-bottom: 1px solid rgb(255, 255, 255); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Arial; font-size: 9pt;">· 굿러브</td>
                            <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;· 춐쉨&quot;}" data-sheets-formula="=&quot;·&quot;&amp;&quot; &quot;&amp;R[0]C[-3]" style="border-right: 1px solid rgb(153, 153, 153); border-bottom: 1px solid rgb(255, 255, 255); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Arial; font-size: 9pt; overflow-wrap: break-word;">· 춐쉨</td>
                          </tr>
                          <tr style="height: 49px;">
                            <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;· 껌정흑설탕&quot;}" data-sheets-formula="=&quot;·&quot;&amp;&quot; &quot;&amp;R[0]C[-3]" style="border-right: 1px solid rgb(255, 255, 255); border-bottom: 1px solid rgb(153, 153, 153); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Arial; font-size: 9pt;">· 껌정흑설탕</td>
                            <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;· 일루절루&quot;}" data-sheets-formula="=&quot;·&quot;&amp;&quot; &quot;&amp;R[0]C[-3]" style="border-right: 1px solid rgb(153, 153, 153); border-bottom: 1px solid rgb(153, 153, 153); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Arial; font-size: 9pt; overflow-wrap: break-word;">· 일루절루</td>
                          </tr>
                          <tr style="height: 21px;">
                            <td style="font-size: 13.3333px; overflow: hidden; padding: 2px 3px; vertical-align: middle;"></td>
                            <td style="font-size: 13.3333px; overflow: hidden; padding: 2px 3px; vertical-align: middle;"></td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <div>
                    <span style="font-family: arial; font-size: 13.3333px;">
                      <b>
                        <span style="font-size: 10pt;">※ 참고하세요.</span>
                      </b>
                    </span>
                    <b>
                  ...
                  <div>
                    <div>
                      ...
                      <div>
                        <div>
                          <span style="font-family: arial; font-size: 10pt;">- 지급된 무료초대권은 쿠폰함에서 확인 가능합니다.</span>
                        </div>
                        <div>
                          <span style="font-family: arial; font-size: 10pt;">- 무료초대권 사용 시 최소 3일 전 해당 숙소 프런트에 문의해 주세요.</span>
                        </div>
                        <div>
                          <span style="font-family: arial; font-size: 10pt;">- 무료초대권은 타인에게 양도하거나 재 판매 할 수 없습니다.</span>
                        </div>
                        <div>
                          <span style="font-family: arial; font-size: 10pt;">- 숙소 사정(광고제휴 종료, 업주변경 등)에 의해 무료초대권 사용이 불가능할 수 있으며, 여기어때에서 대체해 드리지 않습니다.</span>
                        </div>
                        ...
                        <div>
                          <span style="font-family: arial; font-size: 10pt;">- 본 이벤트는 당사의 사정에 의해 변경/중지될 수 있습니다.</span>
                        </div>
                      </div>
                    </div>
                  </div>
