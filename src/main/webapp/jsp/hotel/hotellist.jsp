  ...
  <body class="pc">
    ...
    <main id="product">
      ...
      <div class=body_wrap>
          ...
          <div class="filter_wrap">
            <div class="filter_box">
              <section class="date_wrap">
                ...
                <div class="btn_date">
                  ...
                  <script>
                    ...
                    }); < !--선택한 날짜 값을 URL 파라미터로 추가하고 페이지 새로고침하는 함수-- > function addDatesToURL(checkindate, checkoutdate) {
                      // 현재 페이지 URL 가져오기
              ...
              <section>
                ...
                <ul>
                  <li>
                    <input type="checkbox" id="grade_0" name="grade[]" class="inp_chk" value="5성급" />
                    <label for="grade_0" class="label_chk">5성급</label>
                  </li>
                  <li>
                    <input type="checkbox" id="grade_1" name="grade[]" class="inp_chk" value="특1급" />
                    <label for="grade_1" class="label_chk">특1급</label>
                  </li>
                  <li>
                    <input type="checkbox" id="grade_2" name="grade[]" class="inp_chk" value="특급" />
              ...
              <section>
                ...
                <ul class="hide_type half">
                  <li>
                    <input type="checkbox" id="tmino_24" name="tmino[]" class="inp_chk" value="객실스파" />
                    <label for="tmino_24" class="label_chk">객실스파</label>
                  </li>
                  <li>
                    <input type="checkbox" id="tmino_25" name="tmino[]" class="inp_chk" value="미니바" />
                    <label for="tmino_25" class="label_chk">미니바</label>
                  </li>
                  <li>
                    <input type="checkbox" id="tmino_26" name="tmino[]" class="inp_chk" value="와이파이" />
                    <label for="tmino_26" class="label_chk">와이파이</label>
                  </li>
                  <li>
                    <input type="checkbox" id="tmino_27" name="tmino[]" class="inp_chk" value="욕실용품" />
                    <label for="tmino_27" class="label_chk">욕실용품</label>
                  </li>
                </ul>
              </section>
              <br>
              <section>
                ...
                <ul class="hide_type half">
                  <li>
                    <input type="checkbox" id="tmino_36" name="tmino[]" class="inp_chk" value="반려견동반" />
                    <label for="tmino_36" class="label_chk">반려견동반</label>
                  </li>
                  <li>
                    <input type="checkbox" id="tmino_37" name="tmino[]" class="inp_chk" value="조식포함" />
                    <label for="tmino_37" class="label_chk">조식포함</label>
                  </li>
                  <li>
                    <input type="checkbox" id="tmino_38" name="tmino[]" class="inp_chk" value="객실내흡연" />
                    <label for="tmino_38" class="label_chk">객실내흡연</label>
                  </li>
                  <li>
                    <input type="checkbox" id="tmino_39" name="tmino[]" class="inp_chk" value="발렛파킹" />
                    <label for="tmino_39" class="label_chk">발렛파킹</label>
                  </li>
                </ul>
              </section>
              <br>
              ...
              <script type="text/javascript">
                ...
                } < !--선택한 날짜 값을 URL 파라미터로 추가하고 페이지 새로고침하는 함수-- > function addDataToURL(htype, hbedtype, hcomfort, hpeople) {
                  var urlParams = new URLSearchParams(window.location.search);
                  var hdetailregionV = urlParams.get('hdetailregion');
                  var hpeople = document.querySelector('.cnt_people span').textContent; // 인원 수 값을 가져옴    
                  var checkindate = localStorage.getItem("checkindate"); // checkindate  체크인 값을 가져옴 
        ...
        <div class="right">
          <ul class="sort">
            <!-- <li><a href="#">낮은 가격 순</a></li><li><a href="#">높은 가격 순</a></li> -->
            <li>
              <a href="#" onclick="openMap()">지도</a>
            </li>
          </ul>
          <c:choose>
                  ...
                  <table>
                    <tr>
                      <td width="300px" height="250px">
                        <img src="${hotel.himage} " alt="호텔이미지" width="250px" height="230px">
                      </td>
                      <td>
