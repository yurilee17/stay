	...
	<main id="product">
		...
		showSubMenu();
				...
				function getSelectedOption(selectId) {
					...
					selectedTextUrl = "http://ec2-54-180-94-214.ap-northeast-2.compute.amazonaws.com:8888/stay/GuestHouse?gdetailregion=" + encodeURIComponent(selectedText)+ "&checkindate=${formattedDate}&checkoutdate=${formattedDate}" + encodeURIComponent("");
		...
		<div class=body_wrap>
			...
			<div class="right">
				<ul class="sort">
					...
					<li><a href="#" onclick="openGmap()">지도</a></li>
