...
<div class="visual">
	<div class="hpTop">
		...
		<div class="hpTLeft">
			<img alt="게하이름 | 전경" class="swiper-lazy swiper-lazy-loaded"
			 src="${gh.gimage}"  width="490px" height="348px">
		</div>
		<div class="hpTRight">
			  <td>
	...
	<c:choose>
		<c:when test="${not empty ghrooms}">
			...
			<c:otherwise>
				...
				<p>No guesthouseroom information available.</p>
			</c:otherwise>
		</c:choose>
