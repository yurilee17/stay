		...
		<div class=body_wrap>
			...
			<!-- 초기화, 적용 버튼  -->
						...
						<section>
							<br>
							<ul>
								<li><input type="checkbox" id="reserve_0" name="daesil" class="inp_chk" value="1" /> 
									<label for="reserve_0" class="label_chk">대실 예약</label></li>
								<li><input type="checkbox" id="reserve_1" name="stay" class="inp_chk" value="2" /> 
									<label for="reserve_1" class="label_chk">숙박 예약</label></li>
							</ul>
						</section>
						<br>

						<section>
							<strong>이색테마</strong><br>
							<br>
							<ul class="hide_type half">
								<li><input type="checkbox" id="tmino_0" name="tmino[]" class="inp_chk" value="피트니스" /> 
									<label for="tmino_0" class="label_chk">무인텔</label></li>
								<li><input type="checkbox" id="tmino_1" name="tmino[]" class="inp_chk" value="수영장" /> 
									<label for="tmino_1" class="label_chk">복층룸</label></li>
								<li><input type="checkbox" id="tmino_2" name="tmino[]" class="inp_chk" value="사우나" />
									<label for="tmino_2" class="label_chk">트윈베드</label></li>
								<li><input type="checkbox" id="tmino_3" name="tmino[]" class="inp_chk" value="골프장" /> 
									<label for="tmino_3" class="label_chk">야외테라스</label></li>
							</ul>
						</section>
						<br>

						<section>
							<strong>스파시설</strong><br>
							<br>
							<ul class="hide_type half">
								<li><input type="checkbox" id="tmino_4" name="tmino[]" class="inp_chk" value="객실스파" /> 
									<label for="tmino_4" class="label_chk">스파</label></li>
								<li><input type="checkbox" id="tmino_5" name="tmino[]" class="inp_chk" value="미니바" /> 
									<label for="tmino_5" class="label_chk">사우나</label></li>
								<li><input type="checkbox" id="tmino_6" name="tmino[]" class="inp_chk" value="와이파이" /> 
									<label for="tmino_6" class="label_chk">마사지베드</label></li>
								<li><input type="checkbox" id="tmino_7" name="tmino[]" class="inp_chk" value="욕실용품" /> 
									<label for="tmino_7" class="label_chk">히노끼탕</label></li>
							</ul>
						</section>
						<br>

						<section>
							<strong>놀이시설</strong><br>
							<br>
							<ul class="hide_type half">
								<li><input type="checkbox" id="tmino_8" name="tmino[]" class="inp_chk" value="반려견동반" /> 
									<label for="tmino_8" class="label_chk">수영장</label></li>
								<li><input type="checkbox" id="tmino_9" name="tmino[]" class="inp_chk" value="조식포함" /> 
									<label for="tmino_9" class="label_chk">노래방</label></li>
								<li><input type="checkbox" id="tmino_10" name="tmino[]" class="inp_chk" value="객실내흡연" /> 
									<label for="tmino_10" class="label_chk">당구장</label></li>
								<li><input type="checkbox" id="tmino_11" name="tmino[]" class="inp_chk" value="발렛파킹" /> 
									<label for="tmino_11" class="label_chk">게임기</label></li>
							</ul>
						</section>
						<br>
						<br>
   					 ...
   					 <script type="text/javascript">
						    function comfort() {
						       ...
						       var url = "http://localhost/Main?mdetailregion=" + encodeURIComponent(selectedText) +
				                  "&mtype=" + encodeURIComponent(selectedValues1.join(',')) +
				                  "&moption=" + encodeURIComponent(selectedValues2.join(',')) 
/* 				                  +
								...
								<table>
									<tr>
										...
										<td>
											...
											<p>${motel.mdetailregion }</p> <br> <span>*****</span>
