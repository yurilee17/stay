   ...
   <main id="product">
      ...
      showSubMenu();
            ...
            function getSelectedOption(selectId) {
               ...
               selectedTextUrl = "http://ec2-54-180-94-214.ap-northeast-2.compute.amazonaws.com:8888/stay/pensionMain?pdetailregion=" + encodeURIComponent(selectedText)+ "&checkindate=${formattedDate}&checkoutdate=${formattedDate}" + encodeURIComponent("");
