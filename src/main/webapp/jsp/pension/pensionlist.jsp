	...
	<main id="product">
		...
		showSubMenu();
				...
				function getSelectedOption(selectId) {
					...
					selectedTextUrl = "http://ec2-54-180-94-214.ap-northeast-2.compute.amazonaws.com:8888/stay/Pension?pdetailregion=" + encodeURIComponent(selectedText)+ "&checkindate=${formattedDate}&checkoutdate=${formattedDate}" + encodeURIComponent("");
			    ...
			    var checkoutdateV = urlParams.get('checkoutdate');
				   ...
				   var selectedText = localStorage.getItem("selectedText"); // selectedText  지역 값을 가져옴
					 ...
					 var pdetailregionV = urlParams.get('pdetailregion');
				         ...
				         var updatedURL = "http://ec2-54-180-94-214.ap-northeast-2.compute.amazonaws.com:8888/stay/Pension?pdetailregion=" + encodeURIComponent(pdetailregionV) + "&checkindate=" + encodeURIComponent(checkindate) + "&checkoutdate=" + encodeURIComponent(checkoutdate); 
				        // 페이지 새로고침
						     	    ...
						     	    function addDataToURL(ptype, pcomfort, ppeople) {
						     		  ...
						     		  // 현재 페이지 URL 가져오기
								        ...
								        var updatedURL = removeDuplicateParams(currentURL);
							 	        ...
							 	        var updatedURL = "http://ec2-54-180-94-214.ap-northeast-2.compute.amazonaws.com:8888/stay/PensionMain?pdetailregion=" + encodeURIComponent(pdetailregionV) +"&checkindate=" + encodeURIComponent(checkindate) + "&checkoutdate=" + encodeURIComponent(checkoutdate);
