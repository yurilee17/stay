...
const noPopupOutLinks = ['na_namp', 'da_damp'];

const isNoPopupOutLink = function(kcode) {
    if (!kcode) return false;

    return noPopupOutLinks.some(function(noPopupOutLink) {
        return kcode.includes(noPopupOutLink);
    })
}
...
var popupDialog = (function() {
  ...
  var cookieCheck = function() {
    ...
    if (isNoPopupOutLink(kcode)) return false;
    if (kcode) {
